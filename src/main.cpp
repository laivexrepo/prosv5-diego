...
void opcontrol() {
  ...
  std::cout << "Starting Opcontrol routine \n";

	while (true) {
	  // Lets call the up and down arrow buttons and print a statement to the console
		// Uncomment one of these blocks to test digital_presss versus new_digital_press
	...
	*/
		...
		if(master.get_digital_new_press(DIGITAL_DOWN)) {
			std::cout << "Down Arrow Pressed New Press \n";
		}

		if(master.get_digital_new_press(DIGITAL_UP)) {
			std::cout << "Up Arrow Pressed New Press \n";
		}
